...
n = int(input("Ingrese el valor entero: ")) #tomar entrada de tipo int del usuario
print(n >= 100)  #imprime verdadero si el valor es mayor o igual a 100 #imprime falso si es menor que 100